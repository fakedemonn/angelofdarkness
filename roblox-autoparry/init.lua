--[[
	...
	Run this:
		loadstring(game:HttpGet("https://raw.githubusercontent.com/USER/REPO/main/init.lua"))()
...
local BRANCH = "main"
local REPO = "https://raw.githubusercontent.com/USER/REPO/" .. BRANCH .. "/"
...
local function loadModule(path)
	local fetched, source = pcall(game.HttpGet, game, REPO .. path)
	if not fetched then
